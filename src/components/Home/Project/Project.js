          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                We handle all major smartphones of different brands. Using best
                quality tools and equipment to repair phones.
              </p>
            </div>
            <div className="projectBtn">
              <button className="btn btn-style px-3 text-uppercase mt-3 mb-4">
                Read More
              </button>
            </div>
          </div>
        ...
        <div className="col col-md-4" data-aos="fade-up">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                We offer professional level repairs like reworking on
                motherboards, CPU. And All software related issues.
              </p>
            </div>
            <div className="projectBtn">
              <button className="btn btn-style px-3 text-uppercase mt-3 mb-4">
        ...
        <div className="col col-md-4" data-aos="fade-up-left">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Our Mac, Macbook, Laptop repair service offers you high-quality
                repairs services with premium price in budget.{" "}
              </p>
            </div>
            <div className="projectBtn">
              <button className="btn btn-style px-3 text-uppercase mt-3 mb-4">
